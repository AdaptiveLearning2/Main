...
export default function TeacherLayout() {
  ...
  const [collapsed, toggleCollapsed] = useCollapsedSidebar('teacher')
    ...
    <div className="flex h-screen w-full overflow-hidden bg-slate-50 dark:bg-gray-950">
      ...
      >
        ...
        <button
          ...
          className="absolute -right-3 top-20 w-6 h-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full shadow flex items-center justify-center text-gray-500 hover:text-violet-600 transition z-10 dark:text-gray-400"
        >
