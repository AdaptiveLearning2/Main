...
# Keeps `.rlap` variants (others pin `.pure`) so ubfc_model_comparison_report.txt stays reproducible.
# Check the RLAP licence note before publishing anything from a `.rlap` row.
RPPG_MODELS = [
    "FacePhys.rlap",
    "ME-chunk.rlap",
    "ME-flow.rlap",
