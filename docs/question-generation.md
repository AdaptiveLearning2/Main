...
student has answered is retired instead of rewritten, since their mark was for the old text.
...
retired rather than re-scored, because an answer stores the position of the option chosen. A retired row leaves the
